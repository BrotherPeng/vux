<template>
  ...
  @mouseup="end"
  @touchcancel="end">
    <div class="vux-q-swipeout-button-box vux-q-swipeout-button-box-left" :style="leftButtonBoxStyle" v-show="distX >= 0">
      <slot name="left-menu"></slot>
    </div>
    <div class="vux-q-swipeout-button-box" :style="rightButtonBoxStyle" v-show="distX <= 0">
      <slot name="right-menu"></slot>
    </div>
    <div class="vux-q-swipeout-content" :style="styles" @mousedown="onContentClick" @touchstart="onContentClick" ref="content">
  ...
  methods: {
    ...
    setOffset (x, animated = false, force) {
      ...
      if (animated && this.target) {
        this.target && this.target.classList.add('vux-q-swipeout-content-animated')
        var cb = (function (self, target) {
          return function () {
            target.classList.remove('vux-q-swipeout-content-animated')
